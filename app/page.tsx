      ...
      <section className="py-16 sm:py-24 px-6 sm:px-8 bg-white -mt-24 pt-40 relative section-seamless">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <svg className="w-6 h-6 text-brandPink" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-black text-lg bg-gradient-to-r from-brandPink to-brandGreen bg-clip-text text-transparent">Follow on Instagram</span>
            </Link>
          </motion.div>
        </div>
      </section>
