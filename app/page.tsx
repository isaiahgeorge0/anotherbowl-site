        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Link 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-brandPink to-brandGreen text-white rounded-xl font-bold hover:from-brandGreen hover:to-brandPink transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 relative overflow-hidden group"
            >
              {/* Gradient overlay for text */}
              <div className="absolute inset-0 bg-gradient-to-r from-brandPink to-brandGreen opacity-90 group-hover:opacity-100 transition-opacity duration-300" />
              
              {/* Content with brand color text */}
              <div className="relative z-10 flex items-center gap-3">
                ...
                <span className="text-lg font-black text-white drop-shadow-sm">Follow on Instagram</span>
              </div>
            </Link>
          </motion.div>
        </div>
