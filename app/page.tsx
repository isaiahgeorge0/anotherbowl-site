        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Link 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-brandPink text-white rounded-xl font-bold hover:bg-brandGreen transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
            >
