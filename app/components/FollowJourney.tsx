      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Link 
            ...
            className="button-primary inline-flex min-h-[44px] items-center gap-3 rounded-xl px-8 py-4 shadow-sm hover:shadow-md transition-all duration-300 focus:outline-none"
          >
